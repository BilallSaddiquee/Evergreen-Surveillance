...
def Satellite_View():
    image=url_to_image('https://maps.googleapis.com/maps/api/staticmap?center=Forman%20Christian%20College,Lahore&zoom=18&size=400x400&key=AIzaSyD-dID-nQW8FtF5l45oX9hBgHvdQi0jrWM')
    sat_image=url_to_image('https://maps.googleapis.com/maps/api/staticmap?center=Forman%20Christian%20College,Lahore&zoom=18&size=400x400&maptype=satellite&key=AIzaSyD-dID-nQW8FtF5l45oX9hBgHvdQi0jrWM')
